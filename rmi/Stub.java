...
public class Stub {
            ...
            throws UnknownHostException
    {
        ...
        try{
            return callStubProxy(c,skeleton.getAddr());
        }
        catch (Exception e){
                               ...
                               String hostname)
    {
        ...
        try{
            ...
            return callStubProxy(c,newaddr);
        }
        catch (Exception e) {
            throw new UnsupportedOperationException("not implemented");
        }
    ...
    /**
     * The wrapped function for generating a new Proxy
     * <p>
     *     ClassLoader is generated from interface <code> Class<T> c</code>
     *     interfaces is a Array of interfaces from <code>c</code>
     *     proxyInvocationHandler is generated by <code>c</code> and <code>skeleton</code>
     * </p>
     *
     * @param c A <code>Class</code> object representing the interface
     *                  implemented by the remote object.
     * @param address the skeleton whose port is to be used.
     * @return
     */
    public static <T> T callStubProxy(Class<T> c,InetSocketAddress address){
        proxyInvocationHandler stubHandler = new proxyInvocationHandler(c,address);
